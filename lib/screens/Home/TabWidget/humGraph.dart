...
class _GraphState extends State<HumGraph> {
  ...
  _generateData(mydata) {
    ...
    _seriesBarData.add(
      charts.Series(
        ...
        measureFn: (Sales sales, _) => sales.hum,   // Y軸
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasError) {
          ...
          print(snapshot);
          List<Sales> graphhum = snapshot.data.documents
              .map((documentSnapshot) => Sales.fromMap(documentSnapshot.data))
              .toList();
          return _buildChart(context, graphhum);
        }
      },
    );
  }
